    ...
    return (
      <>
        ...
        <div className={styles.top_banner}>
          ...
          <div className={styles.top_banner_icon}><Image
            src="/woeic_stg/woeic_icon.png"
            fill
            alt='woeic_icon'
            className={styles.top_banner_icon_img} /></div>
        </div>
        <div className={styles.blank} />
        <div className={styles.whatis_banner}>
          <div className={styles.whatis_title}>What is WOEIC STG?</div>
          <div className={styles.whatis_caption}>Learning while <span>playing</span></div>
          <div className={styles.whatis_caption}>Judging words in <span>shooting games</span></div>
          <div className={styles.whatis_caption}>Check the <span>wrong word</span> at the end of the game</div>
        </div>
        <div className={styles.download_banner}>
          <p className={styles.title}>Play on PC</p>
          <p className={styles.caption}>You may need <Link target="_blank" rel="noopener noreferrer" href="https://www.java.com/download/"><span>Java</span></Link> runtime to play.</p>
          <Link href="" style={{ textDecoration: "none" }} className={styles.download_link}>
          ...
          <ul className={styles.vlist}>
            <li>Version 1.0
              <ul>
                <Link href="/woeic_stg/v1.0/WOEIC_STG-Windows-v1.0.zip" download="WOEIC_STG-Windows-v1.0.zip"><li>Windows</li></Link>
                {/* <Link href=""><li>Mac OS</li></Link> */}
                <Link href="/woeic_stg/v1.0/WOEIC_STG-Linux-v1.0.zip"  download="WOEIC_STG-Linux-v1.0.zip"><li>Linux</li></Link>
              </ul>
            </li>
          </ul>
          <p className={styles.title}>Thanks</p>
          <p className={styles.scaption}>The Words in this game are taken from&nbsp;
            <Link
